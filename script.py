...
def registrar_pedido_entregado(pedido_id, repartidor, productos):
    # Asegurando que el 'timestamp' sea el momento actual para evitar el error de tiempo
    repartidor = repartidor["Nombre"]

    url = "http://localhost:8000/registrar_pedido_entregado"
  ...
  # Timestamp del momento actual
    ...
    if response.status_code == 200:
        ...
        print(f"### Error al registrar el pedido entregado: {response.text}")
